...
class Bdd2yolov5:
    def __init__(self, savedir=None):
        ...
        self.select_categorys = ["car", "bus", "truck"]
        self.cat2id = {
            "car": 0,
            "bus": 0,
            "truck": 0
            ...
            for fr in j["frames"]:
                ...
                if len(lines) != 0:
                    ...
                    if self.savedir is not None:
                        basename = os.path.basename(yolo_txt)
                        yolo_txt = os.path.join(self.savedir, basename)
...
if __name__ == "__main__":
    bdd_label_dir = ".\\bdd100k_labels\\bdd100k\\labels\\100k\\val"
    cvt = Bdd2yolov5(".\\yolov5_vehicle_labels\\label\\100k\\val")
